...
import type { User, Gender } from "../types/apiTypes";
type EditUserForm = {
  username: string;
  firstname: string;
  lastname: string;
...
/** Modal for editing user/subadmin - overlay blocks background, Cancel closes. Password optional (leave blank to keep current). */
export const EditUserModal: React.FC<EditUserModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      gender: form.gender, // ✅ add this line
    };
    ...
    try {
      ...
      // API error shown by parent via showError (toast)
    } finally {
      setSaving(false);
    }
  };

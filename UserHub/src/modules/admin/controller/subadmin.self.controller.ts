...
export const subadminLogin = async (req: Request, res: Response) => {
  try {
    ...
    return successResponse(res, "Subadmin login successful", {
      subadmin: {
        id:         admin.id,
        username:   admin.username,
...
// ─── Logout ───────────────────────────────────────────────────────────────────
export const subadminLogout = async (req: Request, res: Response) => {
...
// ─── Profile ──────────────────────────────────────────────────────────────────
export const getSubadminProfile: RequestHandler = async (req, res) => {
  ...
  try {
    ...
    return successResponse(res, "Profile fetched", subadmin, 200);
  } catch (err: any) {
    return errorResponse(res, err.message, 500);
  }
};
...
// ─── Update Profile ───────────────────────────────────────────────────────────
export const updateSubadminProfile: RequestHandler = async (req, res) => {
  const authReq = req as AuthRequest;
  if (!authReq.user) return errorResponse(res, "Unauthorized", 401);
...
// ─── Change Own Password ──────────────────────────────────────────────────────
export const changeSubadminPassword: RequestHandler = async (req, res) => {
  const authReq = req as AuthRequest;
  if (!authReq.user) return errorResponse(res, "Unauthorized", 401);
